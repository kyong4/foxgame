export class UI {
    ...
    draw(context) {
        ...
        //damage taken
        context.fillText('Damage Taken: ' + this.game.score, 20, 50);
        //timer
        ...
        if (this.game.gameOver){ 
            ...
            if (this.game.score >this.game.winningScore) {
                ...
                context.fillText("Total Score:"+(this.game.score+this.game.time*0.001).toFixed(1),this.game.width*0.5, this.game.height*0.5-20);
                context.font=this.fontSize*0.7+'px ' +this.fontFamily;
